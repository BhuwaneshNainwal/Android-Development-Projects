...
public class Motivation extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progress = new ProgressDialog(Motivation.this , ProgressDialog.THEME_HOLO_DARK);
    ...
    private void loadDatainGridView() {
        ...
        db.collection("Data").get()
                .addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                    ...
                    public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                        ...
                        if (!queryDocumentSnapshots.isEmpty()) {
                            ...
                            DataModalAdapter adapter = new DataModalAdapter(Motivation.this, dataModalArrayList);
                            ...
                            Toast.makeText(Motivation.this, "No data found in Database", Toast.LENGTH_SHORT).show();
                        }
                    }
            ...
            public void onFailure(@NonNull Exception e) {
                ...
                Toast.makeText(Motivation.this, "Fail to load data..", Toast.LENGTH_SHORT).show();
