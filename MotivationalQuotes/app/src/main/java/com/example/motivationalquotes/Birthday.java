...
public class Birthday extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progress = new ProgressDialog(Birthday.this , ProgressDialog.THEME_HOLO_DARK);
    ...
    private void loadDatainGridView() {
        ...
        db.collection("Birthday").get()
                .addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                    ...
                    public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                        ...
                        if (!queryDocumentSnapshots.isEmpty()) {
                            ...
                            DataModalAdapter adapter = new DataModalAdapter(Birthday.this, dataModalArrayList);
                            ...
                            Toast.makeText(Birthday.this, "No data found in Database", Toast.LENGTH_SHORT).show();
                        }
                    }
            ...
            public void onFailure(@NonNull Exception e) {
                ...
                Toast.makeText(Birthday.this, "Fail to load data..", Toast.LENGTH_SHORT).show();
