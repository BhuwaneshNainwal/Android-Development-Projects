...
public class Thankful extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.thankful);
        ...
        progress = new ProgressDialog(Thankful.this , ProgressDialog.THEME_HOLO_DARK);
    ...
    private void loadDatainGridView() {
        ...
        db.collection("Thankful").get()
                .addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                    ...
                    public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                        ...
                        if (!queryDocumentSnapshots.isEmpty()) {
                            ...
                            DataModalAdapter adapter = new DataModalAdapter(Thankful.this, dataModalArrayList);
                            ...
                            Toast.makeText(Thankful.this, "No data found in Database", Toast.LENGTH_SHORT).show();
                        }
                    }
            ...
            public void onFailure(@NonNull Exception e) {
                ...
                Toast.makeText(Thankful.this, "Fail to load data..", Toast.LENGTH_SHORT).show();
