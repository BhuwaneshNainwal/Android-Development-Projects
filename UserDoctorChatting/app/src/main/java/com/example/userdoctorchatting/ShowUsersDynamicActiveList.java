...
public class ShowUsersDynamicActiveList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show_users_dynamic_active_list);
    ...
    private void initializeListView() {
        ...
        reference = FirebaseDatabase.getInstance().getReference().child("Active Doctors List");
        ...
        reference.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                ...
                Log.d("Error found",snapshot.getValue(String.class));
